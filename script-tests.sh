...
echo "./ode-pgo tests/test-steps-6-2.xml"
./ode-pgo tests/test-steps-6-2.xml
echo "./ode-pgo tests/test-steps-6-3.xml"
./ode-pgo tests/test-steps-6-3.xml
echo "./ode-pgo tests/test-steps-6-4.xml"
./ode-pgo tests/test-steps-6-4.xml
echo "./ode-pgo tests/test-steps-6-5.xml"
./ode-pgo tests/test-steps-6-5.xml
echo "./ode-pgo tests/test-steps-6-6.xml"
